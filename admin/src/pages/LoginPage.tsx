...
/** Admin sign-in. Mirrors the doctor app's login, minus the role switch. */
        ...
        <div className="bg-white rounded-[32px] shadow-2xl border border-white/20 p-8 lg:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              <span className="inline-flex items-center gap-1.5 mb-4 px-2.5 py-1 rounded-full bg-primary/[0.08] border border-primary/15 text-[11px] font-semibold text-primary uppercase tracking-wider">
